				...
				<div class="row">
					<div class="clearfix col-md-4">
						<div class="logo pull-left">
							<a href="index.html"><img src="<?php echo e(asset('frontend/images/fuel icon.png')); ?>" style="width: 50px; height:50px" alt=""/>
                        </div>
                        ...
                        <div id="slider-carousel" class="carousel slide" data-ride="carousel">
                            ...
                            <div class="carousel-inner">
                                ...
                                <div class="item">
                                    <div class="col-sm-6">
                                        <h1><span>i</span>Fuel</h1>
                                        <h2>Perfect for Doemstic Usage!</h2>
                                        <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. </p>
                                        <button type="button" class="btn btn-default get">Get it now</button>
                                    </div>
                                    <div class="col-sm-6">
				...
				<div class="col-sm-3">
					<div class="left-sidebar">
						...
						<div class="panel-group category-products" id="accordian"><!--category-productsr-->
							...
							<?php $product_by_category = DB::table('tbl_category')
							...
							<div class="panel panel-default">
								<div class="panel-heading">
									<h4 class="panel-title"><a href=<?php echo e(URL::to('/product_by_category/'.$v_product_by_category -> category_id)); ?>><?php echo e($v_product_by_category -> category_name); ?></a></h4>
								</div>
							</div>
							<?php } ?>
						...
						<?php
							...
							foreach($all_published_brand as $v_brand){?>
									...
									<li><a href="#"><?php echo e($v_brand -> brand_name); ?><span class="pull-right">(50)</span></a></li>
...
<?php /**PATH C:\xampp\htdocs\elaravel\resources\views/pages/product_by_category.blade.php ENDPATH**/ ?>
