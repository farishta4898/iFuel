...
<div class="row-fluid sortable">
    <div class="box span12">
        ...
        <div class="box-content">
            <form class="form-horizontal" action="<?php echo e(url('/update_product', $product_info->product_id)); ?>" method="post">
              <fieldset>
    ...
    <div class="control-group hidden-phone">
      ...
      <div class="controls">
        <textarea class="cleditor" name="product_short_description" rows="3" value="<?php echo e($product_info->product_short_description); ?>"></textarea>
      </div>
    </div>
      ...
      <div class="controls">
        <textarea class="cleditor" name="product_long_description" rows="3" value="<?php echo e($product_info->product_long_description); ?>"></textarea>
      </div>
    </div>
    ...
    <div class="control-group">
      ...
      <div class="controls">
        <input type="text" class="input-xlarge" name="product_quantity" value="<?php echo e($product_info->product_quantity); ?>">
      </div>
    </div>
