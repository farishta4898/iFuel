	...
	<div class="navbar">
		<div class="navbar-inner" style="background-color: rgb(255, 255, 255)">
			<div class="container-fluid">
				<h1><a class="brand" href=<?php echo e(URL::to('/')); ?>><img src="<?php echo e(asset('frontend/images/fuel icon.png')); ?>" style="width: 50px; height:50px" alt="">
                   iFuel</h1>
				...
				<div class="nav-collapse sidebar-nav">
					<ul class="nav nav-tabs nav-stacked main-menu">
						...
						<li>
							...
							<ul>
								<li><a class="submenu" href="<?php echo e(URL::to('/all_category')); ?>"><i class="icon-file-alt"></i><span class="hidden-tablet">All Category</span></a></li>
